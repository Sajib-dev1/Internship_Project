									...
									<div class="post post-list-sm circle">
										<div class="thumb circle">
											<a href="{{ route('blog.sngle',$blog->id) }}">
												<div class="inner">
													<img src="{{ asset('uploads/user') }}/{{ $blog->rel_to_user->photo }}" alt="post-title" />
												</div>
											</a>
										</div>
										<div class="details clearfix">
											<h6 class="post-title my-0"><a href="{{ route('blog.sngle',$blog->id) }}">{{ $blog->blog_title }}</a></h6>
											<ul class="meta list-inline mt-1 mb-0">
								...
								<div class="post post-list clearfix">
									...
									<div class="details">
										<ul class="meta list-inline mb-3">
											<li class="list-inline-item image_small"><a href="#"><img width="30" src="{{ asset('uploads/user') }}/{{ $blog->rel_to_user->photo }}" class="author" alt="author"/>{{ $blog->rel_to_user->name }}</a></li>
											<li class="list-inline-item"><a href="{{ route('blog.sngle',$blog->id) }}">{{ $blog->rel_to_cat->category_name }}</a></li>
											<li class="list-inline-item">{{ $blog->created_at->format('d M Y') }}</li>
										</ul>
										<h5 class="post-title"><a href="{{ route('blog.sngle',$blog->id) }}">{{ $blog->blog_title }}</a></h5>
										<p class="excerpt mb-0">{{ Str::substr($blog->summary_blog,0,120) }}</p>
